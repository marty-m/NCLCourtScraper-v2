...
def court8():
    ...
    with sync_playwright() as p:
        ...
        page.wait_for_selector('#ctl00_MainContent_activitiesGrid_ctrl2_lnkListCommand')
        page.locator('//*[@id="ctl00_MainContent_activitiesGrid_ctrl2_lnkListCommand"]').click()
